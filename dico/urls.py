...
urlpatterns = patterns(
    ...
    # ex: /dico/votingHistory
    url(r'^votinghistory/', views.votingHistory, name='votingHistory'),
    # ex: /dico/petition/5/
    ...
    # ex: /dico/editpetition/
    url(r'^editpetition/', views.editPetition, name='editPetition'),
    ...
    # ex: /dico/getvotinghistory/
    url(r'^getvotinghistory/', views.getVotingHistory, name='getVotingHistory'),
    # ex: /dico/newpetition/
    ...
    # ex: /dico/getsearchresults -- Get search results plus votes of the current logged-in user.
    url(r'^getsearchresults/', views.getSearchResults, name='getSearchResults'),
    #
